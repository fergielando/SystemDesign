...
if (isset($_POST['facultyId'], $_POST['deptId'])) {
    ...
    if (isset($_POST['facultyId'], $_POST['deptId'])) {
        ...
        if (mysqli_stmt_num_rows($checkStmt) === 0) {
            ...
            redirectWithMessage("Error: The faculty member is not part of the department.", "facultyinformation.php");
        }
        mysqli_stmt_close($checkStmt);
...
redirectWithMessage("Cannot remove faculty from a department they are currently teaching in.", "facultyinformation.php");
}
mysqli_stmt_close($teachingStmt);
    ...
    header("Refresh: 5; facultyinformation.php");
} catch (Exception $e) {
