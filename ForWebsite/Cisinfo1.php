...
<body>
    ...
    <section>
            ...
            <ul>
                <li>Department Email: <a href="mailto:cisdepartment@ua.uni">cisdepartment@ua.uni</a></li>
            </ul>
            <p>Contact Information:</p>
            <ul>
                <li>Name: Sarah Johnson</li>
                <li>Email: <a href="mailto:SarahJohnson400002@ua.uni">SarahJohnson400002@ua.uni</a></li>
                <li>Phone: (555) 234-5678</li>
                <li>Office: Room 2C</li>
            </ul>
            <ul>
                <li>Name: Richard Baker</li>
