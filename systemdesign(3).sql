...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 12, 2023 at 02:35 AM
...
ALTER TABLE `studentmajor`
  ...
  ADD CONSTRAINT `studentmajor_ibfk_2` FOREIGN KEY (`StudentID`) REFERENCES `user` (`UID`);
...
ALTER TABLE `studentminor`
  ...
  ADD CONSTRAINT `studentminor_ibfk_2` FOREIGN KEY (`StudentID`) REFERENCES `user` (`UID`);
