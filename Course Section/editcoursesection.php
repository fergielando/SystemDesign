...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    $timeslotID = mysqli_real_escape_string($conn, $_POST['timeslot_id']);
...
$query = "SELECT cs.*, c.CourseName FROM coursesection cs 
...
<div class="right-column">
    ...
    <h1>Update Course Section - <?php echo htmlspecialchars($row['CourseName']); ?></h1>
...
<select name="faculty_id" id="faculty_id" required>
        ...
        <input type="text" name="room_id" id="room_id" value="<?php echo $row['RoomID']; ?>" required>
        
        <label for="timeslot_id">Time Slot ID:</label>
        <input type="text" name="timeslot_id" id="timeslot_id" value="<?php echo $row['TimeSlotID']; ?>" required>
